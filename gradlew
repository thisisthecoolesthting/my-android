...
#           ksh Gradle
#
#       Calling this script directly will fail if /bin/sh is not POSIX.  (e.g. if
#       /bin/sh is dash)
#
#   (2) Please use the 'gradlew' script instead of this one.
#
##############################################################################
...
# This is reliable if readlink exists.
